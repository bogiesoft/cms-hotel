...
$result = $db->query("SELECT * FROM pm_article WHERE id_page = ".$page_id." AND checked = 1 AND lang = ".LANG_ID." AND alias = ".$db->quote($article_alias));
...
<article id="page">
    ...
    <div id="content" class="pt30 pb30">
        <div class="container">
            ...
            <?php include(SYSBASE."templates/".TEMPLATE."/common/comments.php"); ?>
        </div>
    </div>
</article>
